  ...
  banner.innerHTML = `
    <div class="flex items-start gap-3 text-left">
      ...
      <div class="min-w-0 flex-1 space-y-2">
        ...
        <p class="text-[0.8125rem] leading-relaxed text-slate-600">Thank you for your enquiry. We will reply directly to <strong class="font-bold select-all">${escapeHtml(email)}</strong> within 2 business days.</p>
        <div class="flex items-center gap-2.5 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5">
          <span class="font-black text-[0.6875rem] uppercase tracking-widest text-slate-500 shrink-0">Ref</span>
          <code id="enquiry-success-ref-value" class="font-bold text-brand-teal select-all text-[0.75rem] tracking-wide flex-1 min-w-0 truncate">${escapeHtml(referenceId)}</code>
          <button
            type="button"
...
export function openEnquiryModal(
  ...
  const textInputClass =
    "w-full bg-white border border-slate-300 rounded-lg px-3.5 py-3 text-[0.8125rem] text-slate-800 placeholder:text-slate-400 transition-colors focus:outline-none focus-visible:outline-none focus:border-brand-teal";
  ...
  const joinedInputClass = `w-full bg-white border border-slate-300 rounded-lg px-3.5 py-3 text-[0.8125rem] text-slate-800 placeholder:text-slate-400 ${seamlessJoinBase} focus:outline-none focus-visible:outline-none focus:border-brand-teal ${inputOpenStateClass}`;
  const emailInputClassPlain = `${textInputClass} pr-10`;
  const emailJoinedInputClass = `w-full bg-white border border-slate-300 rounded-lg px-3.5 py-3 text-[0.8125rem] text-slate-800 placeholder:text-slate-400 pr-10 ${seamlessJoinBase} focus:outline-none focus-visible:outline-none focus:border-brand-teal ${inputOpenStateClass}`;
  const textAreaClass =
    "w-full bg-white border border-slate-300 rounded-lg px-3.5 py-3.5 text-[0.8125rem] text-slate-800 placeholder:text-slate-400 transition-colors focus:outline-none focus-visible:outline-none focus:border-brand-teal resize-none";
    ...
    const rows = items
      .map(
        ...
        <div
          ...
          class="flex items-center gap-2.5 px-3.5 py-2.5 first:pt-3 last:pb-3 border-t border-slate-200/70 hover:bg-slate-50 transition-colors cursor-pointer"
        >
          <button
            type="button"
          ...
          >
            ...
            <span class="${emailValClass} text-[0.75rem] font-semibold truncate min-w-0 select-all ${
    ...
    return {
      ...
      >
        <div class="px-3.5 pt-2.5 pb-1.5">
          <span class="font-black text-[0.6875rem] uppercase tracking-widest text-slate-400">Recent</span>
        </div>
        ${rows}
      </div>
      `,
  ...
  container.innerHTML = `
    ...
    >
      ...
      <div class="w-full px-4 py-5 pr-4 border-b border-slate-100 shrink-0 text-left sm:px-6 sm:pr-20">
        <span class="font-sans font-black text-[0.6875rem] uppercase text-brand-teal tracking-widest block mb-1.5">Enquiries</span>
        <h2 id="enquiry-modal-title" class="font-sans font-extrabold text-slate-900 text-xl leading-tight">Start Your Project</h2>
        <p id="enquiry-modal-description" class="text-[0.8125rem] text-slate-400 mt-1 leading-relaxed">
        ...
        <div data-enquiry-mode-switch class="enquiry-mode-switch mt-4 grid w-full grid-cols-2 rounded-xl bg-slate-100 p-1" role="tablist" aria-label="Enquiry type">
          ...
          <button type="button" data-enquiry-mode="standard" role="tab" aria-selected="false" class="relative z-10 rounded-lg px-3 py-2 text-[0.75rem] font-bold uppercase tracking-wider transition-colors sm:px-3.5 sm:py-2.5 sm:text-[0.75rem]">Ask a Question</button>
          <button type="button" data-enquiry-mode="care" role="tab" aria-selected="false" class="relative z-10 rounded-lg px-3 py-2 text-[0.75rem] font-bold uppercase tracking-wider transition-colors sm:px-3.5 sm:py-2.5 sm:text-[0.75rem]">Enquire About Services</button>
        </div>
      </div>
        ...
        <form id="enquiry-multi-step-form" class="enquiry-multi-step-form space-y-8 pb-4 max-w-4xl mx-auto" novalidate aria-describedby="enquiry-security-note">
          <section id="enquiry-sec-contact" class="space-y-5 scroll-mt-6">
            <div class="border-b border-slate-100 pb-3">
              ...
              <p class="text-[0.8125rem] text-slate-400">Please provide your primary direct contact information.</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="space-y-1 text-left">
                <label for="enq-name" class="font-black text-[0.6875rem] uppercase tracking-wider text-slate-500 block">Your Full Name <span class="text-brand-orange">*</span></label>
              ...
              <div class="space-y-1 text-left">
                <label for="enq-email" class="font-black text-[0.6875rem] uppercase tracking-wider text-slate-500 block">Email Address <span class="text-brand-orange">*</span></label>
            ...
            <div class="space-y-1 text-left">
              <label for="enq-phone" class="font-black text-[0.6875rem] uppercase tracking-wider text-slate-500 block">Phone Number <span class="text-slate-400">(Optional)</span></label>
          ...
          <section id="enquiry-sec-company" class="space-y-5 scroll-mt-6">
            ...
            <div class="space-y-1 text-left">
              <label for="enq-company-name" class="font-black text-[0.6875rem] uppercase tracking-wider text-slate-500 block">Company / Business Name <span class="text-slate-400">(Optional)</span></label>
            ...
            <div class="space-y-1 text-left">
              <label for="enq-company-address" class="font-black text-[0.6875rem] uppercase tracking-wider text-slate-500 block">Company Address <span class="text-slate-400">(Optional)</span></label>
          ...
          <section id="enquiry-sec-service" class="space-y-5 scroll-mt-6">
            ...
            <div class="space-y-2 text-left">
              <div class="flex flex-wrap items-center gap-x-3 gap-y-1">
                <p id="enquiry-plan-label" class="font-black text-[0.6875rem] uppercase tracking-wider text-slate-500 block">Select Package Option <span class="text-brand-orange">*</span></p>
                <span id="enq-service-error" class="hidden rounded-full border border-rose-200 bg-rose-50 px-3 py-1.5 text-[0.75rem] font-semibold tracking-wide text-rose-700" role="alert"></span>
              </div>
              <p id="enquiry-plan-hint" class="text-[0.8125rem] text-slate-400 leading-relaxed">Each upfront build includes a free first month of the matching care tier, followed by the monthly fee shown below. Required care keeps your site hosted, secured, and maintained.</p>
              <div id="service-options-wrapper" class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-7 transition-colors" role="radiogroup" aria-labelledby="enquiry-plan-label" aria-describedby="enquiry-plan-hint enq-service-error">
                <div class="flex flex-col space-y-3">
                  ...
                  >
                    <div class="flex items-center justify-between mb-1.5">
                      <span class="font-sans font-black text-[0.6875rem] uppercase tracking-widest text-blue-600">BASIC BUILD</span>
                    ...
                    <h4 class="font-sans font-extrabold text-slate-900 text-base">Basic <span class="text-blue-600 font-normal">| £199 <span class="line-through text-slate-400 text-[0.75rem]">£499</span></span></h4>
                  </div>
                  <ul class="space-y-2 text-[0.8125rem] text-slate-500 grow pl-1">
                ...
                <div class="flex flex-col space-y-3">
                  ...
                  >
                    <div class="flex items-center justify-between mb-1.5">
                      <span class="font-sans font-black text-[0.6875rem] uppercase tracking-widest text-brand-orange">STANDARD BUILD</span>
                      <div class="plan-radio-circle w-4 h-4 rounded-full border border-slate-300 flex items-center justify-center bg-white transition-colors">
                        <div class="plan-radio-dot w-2 h-2 rounded-full bg-brand-orange scale-0 transition-transform"></div>
                      </div>
                    </div>
                    <h4 class="font-sans font-extrabold text-slate-900 text-base">Standard <span class="text-brand-orange font-normal">| £349 <span class="line-through text-slate-400 text-[0.75rem]">£799</span></span></h4>
                  </div>
                  <ul class="space-y-2 text-[0.8125rem] text-slate-500 grow pl-1">
                    <li class="flex items-start gap-1.5">
                ...
                <div class="flex flex-col space-y-3">
                  ...
                  >
                    <div class="flex items-center justify-between mb-1.5">
                      <span class="font-sans font-black text-[0.6875rem] uppercase tracking-widest text-brand-teal">PREMIUM BUILD</span>
                      <div class="plan-radio-circle w-4 h-4 rounded-full border border-slate-300 flex items-center justify-center bg-white transition-colors">
                        <div class="plan-radio-dot w-2 h-2 rounded-full bg-brand-teal scale-0 transition-transform"></div>
                      </div>
                    </div>
                    <h4 class="font-sans font-extrabold text-slate-900 text-base">Premium <span class="text-brand-teal font-normal">| £499 <span class="line-through text-slate-400 text-[0.75rem]">£1299</span></span></h4>
                  </div>
                  <ul class="space-y-2 text-[0.8125rem] text-slate-500 grow pl-1">
                    <li class="flex items-start gap-1.5">
                    ...
                    <li class="flex items-start gap-1.5">
                      <span class="text-brand-teal shrink-0 mt-0.5">✓</span>
                      <span>Priority build queue and 30-day pro care launch ramp</span>
                    </li>
                    <li class="flex items-start gap-1.5">
                      <span class="text-brand-teal shrink-0 mt-0.5">✓</span>
                ...
                <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-8 pt-7 border-t border-slate-200">
                  <div class="flex flex-col space-y-3">
                    ...
                    >
                      <div class="flex items-center justify-between mb-1.5">
                        <span class="font-sans font-black text-[0.6875rem] uppercase tracking-widest text-slate-500">ESSENTIAL CARE</span>
                        <div class="plan-radio-circle w-4 h-4 rounded-full border border-slate-300 flex items-center justify-center bg-white transition-colors">
                  ...
                  <div class="flex flex-col space-y-3">
                    ...
                    >
                      <div class="flex items-center justify-between mb-1.5">
                        <span class="font-sans font-black text-[0.6875rem] uppercase tracking-widest text-brand-orange">GROWTH CARE</span>
                        <div class="plan-radio-circle w-4 h-4 rounded-full border border-slate-300 flex items-center justify-center bg-white transition-colors">
                          <div class="plan-radio-dot w-2 h-2 rounded-full bg-brand-orange scale-0 transition-transform"></div>
                        </div>
                      </div>
                  ...
                  <div class="flex flex-col space-y-3">
                    ...
                    >
                      <div class="flex items-center justify-between mb-1.5">
                        <span class="font-sans font-black text-[0.6875rem] uppercase tracking-widest text-brand-teal">PRO CARE</span>
                        <div class="plan-radio-circle w-4 h-4 rounded-full border border-slate-300 flex items-center justify-center bg-white transition-colors">
                          <div class="plan-radio-dot w-2 h-2 rounded-full bg-brand-teal scale-0 transition-transform"></div>
                        </div>
                      </div>
                ...
                <div class="md:col-span-3 pt-7 border-t border-slate-200">
                  ...
                  >
                    ...
                    <div class="relative z-10 md:flex-1">
                      <span class="font-sans font-black text-[0.6875rem] uppercase tracking-[0.22em] text-brand-orange">BESPOKE · PROJECT</span>
                      <h4 class="font-sans font-extrabold text-slate-900 text-[13.5px] leading-tight mt-1">Bespoke / Custom Project</h4>
                      <p class="text-[0.8125rem] text-slate-600 leading-snug mt-1.5 max-w-md">Custom scoping, ecommerce, bookings and integrations · line-itemised quote.</p>
                    </div>
                    <ul class="relative z-10 space-y-2 text-[0.8125rem] text-slate-600 md:flex-1">
          ...
          <section id="enquiry-sec-additional" class="space-y-5 scroll-mt-6">
            ...
            <div class="space-y-1 text-left">
              <label for="enq-message" class="font-black text-[0.6875rem] uppercase tracking-wider text-slate-500 block"><span id="enquiry-message-label">Tell us about your requirements</span> <span class="text-brand-orange">*</span></label>
            ...
            <div class="pt-4 pb-4 space-y-3">
              <p id="enquiry-security-note" class="text-[0.8125rem] text-slate-400 leading-relaxed text-left">
              ...
              <button 
                ...
                type="submit" 
                class="w-full bg-brand-teal hover:bg-brand-teal-dark text-white font-bold p-4 rounded-lg text-[0.8125rem] cursor-pointer flex justify-center items-center gap-2.5 uppercase tracking-widest font-mono transition-colors border-none"
              >
                <span>Submit</span>
              </button>
            </div>
  ...
  const applyEnquiryMode = (mode: "standard" | "care"): void => {
    ...
    modeButtons.forEach((button) => {
      ...
      button.className = active
        ? "relative z-10 rounded-lg px-3 py-2 text-[0.75rem] font-bold uppercase tracking-wider text-brand-teal transition-colors"
        : "relative z-10 rounded-lg px-3 py-2 text-[0.75rem] font-bold uppercase tracking-wider text-slate-500 transition-colors hover:text-slate-800";
    });
  };
  ...
  form?.addEventListener("submit", async (e: SubmitEvent) => {
    ...
    try {
      ...
      const errorAlert = showFormAlert(
        form,
        `<p class="font-bold mb-1.5">Enquiry Delivery Failed</p><p class="text-[0.8125rem] text-rose-700">${formatSupportEmailMarkup(errorMessage)}</p>`,
        {
          id: "enq-error-alert",
          beforeEl:
