    ...
    <div id="demo-modal-card" class="bg-white rounded-xl shadow-2xl border border-slate-100 max-w-md w-full p-6 text-left relative overflow-hidden animate-slide-in-up" role="document">
      ...
      <div class="flex items-start gap-4 mt-2">
        ...
        <div class="space-y-1.5">
          ...
          <span class="inline-block bg-amber-50 text-amber-800 text-[0.75rem] font-bold px-2.5 py-1 rounded border border-brand-orange/40 font-mono tracking-wider">
            MOCK PREVIEW
          </span>
        </div>
      </div>
      ...
      <div class="mt-5 space-y-3 text-sm text-slate-600 leading-relaxed">
        ...
        <p class="text-[0.8125rem] text-slate-500 font-mono italic leading-relaxed">
