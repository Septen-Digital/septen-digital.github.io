...
export const legalTabContent: Record<LegalTab, string> = {
  terms: `
    <p class="font-extrabold text-brand-teal-dark uppercase text-[0.75rem] tracking-widest">Septen - Website Terms of Use</p>
  ...
  `,
  privacy: `
    <p class="font-extrabold text-brand-teal-dark uppercase text-[0.75rem] tracking-widest">Septen - Privacy Policy</p>
    <p><strong>Last updated:</strong> 16 September 2026</p>
  ...
  `,
  cookies: `
    <p class="font-extrabold text-brand-teal-dark uppercase text-[0.75rem] tracking-widest">Septen - Cookie Policy</p>
    <p><strong>Last updated:</strong> 16 September 2026</p>
  ...
  `,
  "data-rights": `
    <p class="font-extrabold text-brand-teal-dark uppercase text-[0.75rem] tracking-widest">Septen - Data Rights</p>
    <p><strong>Last updated:</strong> 16 September 2026</p>
  ...
  `,
  disclaimer: `
    <p class="font-extrabold text-brand-teal-dark uppercase text-[0.75rem] tracking-widest">Septen - Disclaimer</p>
    <p><strong>Last updated:</strong> 16 September 2026</p>
