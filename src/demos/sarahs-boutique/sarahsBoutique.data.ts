...
export const sarahsBoutiqueCategories = [
  "All",
  "Dresses",
  "Outerwear",
  "Tops",
...
export type SarahsBoutiqueView =
  "home" | "catalogue" | "product-detail" | "about" | "visit";
export type SarahsBoutiqueCategory =
  (typeof sarahsBoutiqueCategories)[number];

// These IDs are shared between Astro markup and the client-side controller so
// anchors, focus targets, and enhanced navigation stay in lockstep.
export const sarahsBoutiqueRootId = "sarahs-boutique-demo-root";
export const sarahsBoutiqueViewIds = {
  home: "boutique-home",
  catalogue: "boutique-catalogue",
  about: "boutique-about",
  visit: "boutique-visit",
} as const;
export const sarahsBoutiqueVisitConfirmationId = "boutique-visit-confirmation";

export type SarahsBoutiqueProduct = {
  id: string;
  name: string;
  price: string;
  category: SarahsBoutiqueCategory;
  image: ImageMetadata;
  shortDesc: string;
  longDesc: string;
  sizing: string;
...
// These helpers deliberately keep anchor generation deterministic, because both
// the no-JS CSS fallback and the hydrated client controller depend on them.
export function getSarahsBoutiqueProductDetailId(productId: string): string {
  return `boutique-detail-${productId}`;
}

export function getSarahsBoutiqueCategoryAnchorId(
  category: SarahsBoutiqueCategory,
): string {
  return `boutique-category-${category.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`;
}
...
export const sarahsBoutiqueInventory: SarahsBoutiqueProduct[] = [
  {
    ...
    shortDesc:
      "Effortless flowing maxi dress in pure organic silk with fluid drapery.",
    longDesc:
  ...
  },
  {
    ...
    image: cameloreImage,
    shortDesc:
      "Tailored double-breasted coat made of premium Italian cashmere.",
    longDesc:
    ...
    sizing:
      "Relaxed tailored cut. Designed for layering over thick knitwear. Model is 5'10\" and wears size M.",
    materials:
      "90% Recycled Cashmere, 10% Extra-fine Merino Wool, 100% Bio-degradable flax lining.",
  },
  {
    id: "prod-3",
    ...
    image: helenaImage,
    shortDesc:
      "Finely-ribbed wool blend with subtle back split and high mock neck.",
    longDesc:
  ...
  },
  {
    ...
    image: noorImage,
    shortDesc:
      "Sculpted oversized cocoon coat crafted in thick Yorkshire felted wool.",
    longDesc:
    ...
    sizing:
      "Intentionally oversized. If you prefer a closer fit, please size down.",
  ...
  },
  {
    ...
    image: sylviaImage,
    shortDesc:
      "Relaxed button-down utility shirt styled with French-seam cuffs.",
    longDesc:
  ...
  },
  {
    ...
    image: auraImage,
    shortDesc:
      "Feather-light merino turtleneck with clean rolled-edge accents.",
    longDesc:
  ...
  },
  {
    ...
    shortDesc:
      "Raw-edged luxury suede shoulder bag with solid hand-carved brass clasps.",
    longDesc:
  ...
  },
  {
    ...
    image: lichenImage,
    shortDesc:
      "Hand-brushed wool scarf colored with natural moss pigment extracts.",
    longDesc:
  ...
  },
  {
    ...
    image: northSeaImage,
    shortDesc:
      "Traditional heavy wool knit cape with high structural windproof storm collar.",
    longDesc:
...
export const sarahsBoutiqueFeaturedProducts = sarahsBoutiqueInventory.slice(
  0,
  3,
);
