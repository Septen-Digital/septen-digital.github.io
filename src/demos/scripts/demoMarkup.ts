...
import {
  initPetersPlumbing,
  renderPetersPlumbing,
} from "@demos/alder-and-pipe-plumbing/PetersPlumbing";
import {
...
export const demoRegistry: Record<DemoSlug, DemoEntry> = {
  ...
  "alder-and-pipe-plumbing": {
    ...
    description:
      "Interactive plumbing demo website showcasing Septen's trade business layouts.",
  ...
  "sarahs-boutique": {
    ...
    description:
      "Interactive boutique demo website showcasing Septen's retail design work.",
  },
  "greenfield-landscaping": {
