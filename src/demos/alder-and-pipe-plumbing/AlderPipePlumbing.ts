    ...
    <div class="bg-[#FAFBFB] min-h-screen text-[#334155] font-sans antialiased text-left">
      ...
      <section class="bg-[#FAFBFB] border-b border-slate-100 min-h-[calc(100svh-6rem)] md:min-h-[calc(100svh-4.5rem)] flex flex-col justify-center">
        <div class="w-full max-w-5xl xl:max-w-6xl 2xl:max-w-7xl 3xl:max-w-360 4xl:max-w-[110rem] mx-auto px-6 xl:px-10 2xl:px-14 3xl:px-20 4xl:px-24 py-10 md:py-12 xl:py-16 3xl:py-24 grid grid-cols-1 md:grid-cols-12 gap-12 xl:gap-16 3xl:gap-20 4xl:gap-24 items-center">
          ...
          <div class="md:col-span-6 space-y-6 xl:space-y-8 3xl:space-y-10 text-left" data-reveal>
            <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-[#2C5282] font-extrabold font-mono block">
            ...
            <div class="flex flex-col sm:flex-row gap-3 xl:gap-4 pt-2 xl:pt-4">
              <a
                href="#contact"
                class="bg-[#2C5282] hover:bg-[#1A365D] text-white font-bold text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4 3xl:py-5 px-6 xl:px-8 3xl:px-10 rounded transition-colors hover-button-polish border-none cursor-pointer tracking-wider text-center inline-flex items-center justify-center"
              >
                Request Consultation
              </a>
              <a 
                href="#services"
                class="bg-transparent hover:border-[#2C5282] hover:text-[#1A365D] hover:shadow-[0_0.85rem_2rem_rgba(15,23,42,0.08)] text-[#2C5282] border-slate-300 border border-solid text-center font-bold text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4 3xl:py-5 px-6 xl:px-8 3xl:px-10 rounded transition-all cursor-pointer tracking-wider inline-flex items-center justify-center"
              >
                Explore Services
              </a>
            </div>

            <div class="flex gap-6 xl:gap-8 pt-2 xl:pt-4 text-xs xl:text-sm 3xl:text-base text-slate-500 font-mono">
      ...
      <section id="about" class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl mx-auto px-6 py-16 2xl:py-20 3xl:py-24 text-left">
        <div class="max-w-2xl 3xl:max-w-3xl space-y-4 3xl:space-y-6" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm text-[#2C5282] font-black uppercase font-mono tracking-widest">Our Approach</span>
      ...
      <section id="services" class="bg-white border-y border-stone-200/60 py-20 2xl:py-24 3xl:py-28">
        <div class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl mx-auto px-6 text-left">
          <div class="mb-12 3xl:mb-16" data-reveal>
            <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-[#2C5282] font-black">Domestic Care</span>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 3xl:gap-12">
            ...
            <div class="space-y-3 3xl:space-y-5 hover-lift transition-transform duration-300" data-reveal data-reveal-delay="40">
              ...
              <p class="text-xs md:text-sm xl:text-base 3xl:text-lg text-slate-600 leading-relaxed">
            ...
            <div class="space-y-3 3xl:space-y-5 bg-slate-50 p-6 3xl:p-10 rounded border border-slate-100 hover-lift transition-transform duration-300" data-reveal data-reveal-delay="240">
              ...
              <p class="text-[11px] xl:text-xs 3xl:text-base text-slate-500 leading-relaxed">
      ...
      <section id="examples" class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20 py-20 2xl:py-24 3xl:py-28 text-left">
        <div class="mb-12 3xl:mb-16" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-[#2C5282] font-black">Our Archive</span>
          ...
          <p class="text-[#334155]/70 text-xs xl:text-sm 3xl:text-base mt-1.5 3xl:mt-3 font-mono">Real-world stories from local domestic installations</p>
        </div>
          ...
          ${caseStudies
            ...
            <div class="bg-white rounded-lg p-6 md:p-8 3xl:p-12 border border-stone-200/70 shadow-sm space-y-4 3xl:space-y-6 hover-lift transition-transform duration-300" data-reveal>
              <div class="border-b border-slate-100 pb-3 3xl:pb-5 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 3xl:gap-3">
                ...
                <span class="text-xs xl:text-sm 3xl:text-base text-slate-400 font-mono italic">${study.subtitle}</span>
              </div>
              <p class="text-sm md:text-base xl:text-lg 3xl:text-xl text-slate-600 leading-relaxed">${study.story}</p>
              <div class="bg-slate-50/70 p-4 3xl:p-6 rounded border-l-2 3xl:border-l-[3px] border-[#2C5282] text-xs xl:text-sm 3xl:text-lg text-slate-700 italic font-medium leading-relaxed">
      ...
      <section class="bg-slate-950 text-slate-300 py-16 2xl:py-20 3xl:py-28 border-t border-slate-900">
        <div class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20 text-left space-y-8 3xl:space-y-12">
          <div data-reveal>
            <span class="text-[9px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-[#82B0D2] font-black font-mono block">Workmanship Credentials</span>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 3xl:gap-12">
            <div class="space-y-2 3xl:space-y-4 hover-lift transition-transform duration-300" data-reveal data-reveal-delay="60">
              ...
              <p class="text-xs md:text-sm xl:text-base 3xl:text-lg text-slate-400 leading-relaxed">
      ...
      <section id="contact" class="bg-[#FAFBFB] py-16 2xl:py-20 3xl:py-24 border-t border-stone-200 text-center">
        <div class="max-w-xl 2xl:max-w-2xl 3xl:max-w-3xl mx-auto px-6 xl:px-10 3xl:px-20 space-y-6 3xl:space-y-8" data-reveal>
          ...
          <form id="alder-pipe-enquiry-form" class="space-y-3 3xl:space-y-5 max-w-sm 2xl:max-w-md 3xl:max-w-lg mx-auto text-left">
            <div>
              <label for="alder-pipe-name" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-slate-500 font-bold block leading-4 mb-1.5 3xl:mb-2.5">Your Name</label>
              <input id="alder-pipe-name" name="name" type="text" required placeholder="William Armstrong" class="w-full bg-white border border-stone-200 rounded p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base text-slate-800 focus:outline-none focus:border-[#2C5282]" />
            </div>
            <div>
              <label for="alder-pipe-postcode" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-slate-500 font-bold block leading-4 mb-1.5 3xl:mb-2.5">Home Postcode</label>
              <input id="alder-pipe-postcode" name="postcode" type="text" required placeholder="e.g. NE3 1AA" class="w-full bg-white border border-stone-200 rounded p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base text-slate-800 focus:outline-none focus:border-[#2C5282]" />
            </div>
            <div>
              <label for="alder-pipe-details" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-slate-500 font-bold block leading-4 mb-1.5 3xl:mb-2.5">Request details</label>
              <textarea id="alder-pipe-details" name="details" rows="3" 3xl:rows="4" placeholder="Describe your domestic plumbing plans or maintenance requirements..." class="w-full bg-white border border-stone-200 rounded p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base text-slate-800 focus:outline-none focus:border-[#2C5282] resize-none font-sans"></textarea>
            </div>
            <button type="submit" class="w-full bg-[#2C5282] hover:bg-[#1A365D] text-white font-bold p-3 xl:p-4 3xl:p-5 text-xs xl:text-sm 3xl:text-base uppercase tracking-widest hover-button-polish font-mono rounded border-none cursor-pointer">
              Schedule Discussion
            </button>
          </form>
        </div>
      ...
      <!-- Footer -->
      <footer class="bg-white border-t border-stone-200 py-8 text-center text-xs text-slate-600 font-mono">
        © 2026 Septen
      </footer>
