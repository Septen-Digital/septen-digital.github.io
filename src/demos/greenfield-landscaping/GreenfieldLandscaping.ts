    ...
    <div id="greenfield-demo-root" class="bg-[#FAF9F5] min-h-screen overflow-x-hidden text-[#223322] font-sans antialiased text-left">
        ...
        <div class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl mx-auto px-4 sm:px-6 xl:px-10 3xl:px-20 py-4 xl:py-5 flex flex-col md:flex-row justify-between items-center gap-4">
          <div class="flex items-center justify-center md:justify-start gap-2 w-full md:w-auto min-w-0">
            ...
            <span class="font-serif font-bold text-lg xl:text-xl 3xl:text-2xl text-stone-900 tracking-tight text-center md:text-left leading-tight wrap-break-word">
              Greenfield Landscaping <span class="text-stone-600 font-sans text-xs 3xl:text-sm font-normal">UK</span>
            </span>
          </div>

          <div class="flex w-full md:w-auto flex-wrap justify-center items-center gap-x-4 gap-y-2.5 md:gap-x-6 3xl:gap-x-8 text-[0.6875rem] sm:text-xs xl:text-sm 3xl:text-base font-semibold uppercase tracking-widest text-[#223322]">
            <a href="#services">Services</a>
            <a href="#portfolio">Portfolio</a>
            <a
              href="#contact"
              class="bg-[#2C5E3B] hover:bg-[#1E4228] text-white px-4 py-2 xl:px-5 xl:py-2.5 rounded text-[10px] xl:text-xs 3xl:text-sm uppercase font-bold tracking-widest transition-colors hover-button-polish border-none font-mono shrink-0 inline-block text-center no-underline"
            >
              Get a Quote
            </a>
          </div>
      ...
      <section class="relative bg-stone-950 text-white overflow-hidden border-b border-[#2C5E3B]/10 min-h-[calc(100svh-6rem)] md:min-h-[calc(100svh-4.5rem)] flex flex-col justify-center">
        ...
        <div class="relative z-10 w-full max-w-4xl 2xl:max-w-5xl 3xl:max-w-6xl 4xl:max-w-360 mx-auto px-4 sm:px-6 xl:px-10 3xl:px-20 py-10 md:py-12 xl:py-16 3xl:py-24 space-y-6 xl:space-y-8 3xl:space-y-10 text-left" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-[0.25em] text-[#D9F5DE] font-black font-mono block">
          ...
          <div class="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 xl:gap-6 pt-3 xl:pt-6">
            <a
              href="#contact"
              class="w-full sm:w-auto bg-[#2C5E3B] hover:bg-[#1E4228] text-white font-bold text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4 3xl:py-5 px-6 xl:px-8 3xl:px-10 rounded transition-colors hover-button-polish border-none text-center inline-flex items-center justify-center"
            >
              Consult Our Team
            </a>
            <a 
              href="#portfolio"
              class="w-full sm:w-auto bg-stone-950/70 hover:border-white/40 hover:text-white hover:shadow-[0_0.85rem_2rem_rgba(15,23,42,0.12)] text-white border border-solid border-white/20 font-bold text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4 3xl:py-5 px-6 xl:px-8 3xl:px-10 rounded transition-all text-center inline-flex items-center justify-center"
            >
              View Completed Work
            </a>
          </div>

          <div class="flex flex-col sm:flex-row gap-3 sm:gap-6 xl:gap-8 pt-4 xl:pt-6 text-xs xl:text-sm 3xl:text-base font-mono text-stone-300">
      ...
      <section id="services" class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20 py-20 2xl:py-24 3xl:py-28 text-left">
        <div class="border-b border-stone-200 pb-6 3xl:pb-8 mb-12 3xl:mb-16" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-[#2C5E3B] font-black block">What We Do</span>
          ...
          <p class="text-xs xl:text-sm 3xl:text-base text-stone-500 font-serif italic mt-1 3xl:mt-3">Groundwork, woodwork, and brick installations completed to professional trade standards.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 3xl:gap-12">
          ...
          <div class="space-y-2.5 3xl:space-y-4 hover-lift transition-transform duration-300" data-reveal data-reveal-delay="40">
            ...
            <p class="text-xs xl:text-sm 3xl:text-base text-stone-600 leading-relaxed font-sans">
          ...
          <div class="bg-[#FAF9F5] border border-stone-200 p-5 3xl:p-8 rounded space-y-2 3xl:space-y-3 flex flex-col justify-between hover-lift transition-transform duration-300" data-reveal data-reveal-delay="240">
            <div>
              <h4 class="text-xs xl:text-sm 3xl:text-base font-mono font-bold uppercase text-stone-500">Trade Promise</h4>
              <p class="text-[11px] xl:text-sm 3xl:text-base text-stone-600 mt-1 3xl:mt-2 font-serif italic">
            ...
            <span class="text-[9px] xl:text-xs 3xl:text-sm font-mono text-stone-400 font-bold">— Peter Greenfield, Founder</span>
          </div>
      ...
      <section id="portfolio" class="bg-white border-y border-stone-200/60 py-20 2xl:py-24 3xl:py-28">
        <div class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-4 sm:px-6 xl:px-10 3xl:px-20 text-left">
          <div class="mb-12 3xl:mb-16" data-reveal>
            <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-[#2C5E3B] font-black">Our Portfolio</span>
            ...
            <p class="text-stone-500 text-xs xl:text-sm 3xl:text-base mt-1.5 3xl:mt-3 font-mono">Narrative logs documenting actual domestic projects</p>
          </div>
              ...
              <div class="bg-[#FAF9F5] border border-stone-200 rounded p-6 2xl:p-8 3xl:p-10 shadow-xs flex flex-col justify-between space-y-4 3xl:space-y-6 hover-lift transition-transform duration-300 min-w-0" data-reveal>
                <div class="space-y-3 3xl:space-y-5">
                  <div class="border-b border-stone-200/65 pb-2 3xl:pb-3 flex flex-col sm:flex-row sm:justify-between sm:items-baseline gap-2">
                    ...
                    <span class="inline-flex w-fit max-w-full whitespace-normal leading-relaxed text-[8px] sm:text-[9px] xl:text-xs 3xl:text-sm font-mono text-[#2C5E3B] bg-[#2C5E3B]/10 px-2 py-1 3xl:px-3 3xl:py-1.5 rounded font-black uppercase shrink-0">
                      ${study.scope}
                    </span>
                  </div>
                  <p class="text-xs xl:text-sm 3xl:text-base text-stone-600 leading-relaxed font-sans">
                ...
                <div class="bg-white border border-stone-200/40 p-3.5 3xl:p-5 rounded text-xs xl:text-sm 3xl:text-base italic font-serif text-stone-700">
      ...
      <section class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-4 sm:px-6 xl:px-10 3xl:px-20 py-16 2xl:py-20 3xl:py-24 text-left">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 3xl:gap-10">
          ...
          <div class="bg-stone-100 border border-stone-200 rounded overflow-hidden hover-lift transition-transform duration-300" data-reveal data-reveal-delay="60">
            ...
            <div class="bg-stone-100 p-4 3xl:p-6 text-xs xl:text-sm 3xl:text-base font-mono text-stone-500">
      ...
      <section id="contact" class="bg-stone-100 border-t border-stone-200 py-16 2xl:py-20 3xl:py-24 text-center">
        <div class="max-w-xl 2xl:max-w-2xl 3xl:max-w-3xl mx-auto px-4 sm:px-6 xl:px-10 3xl:px-20 space-y-6 xl:space-y-8 3xl:space-y-10" data-reveal>
          ...
          <p class="text-xs md:text-sm xl:text-lg 2xl:text-xl 3xl:text-2xl text-stone-500 max-w-sm 2xl:max-w-xl 3xl:max-w-2xl mx-auto leading-relaxed">
          ...
          <form id="greenfield-contact-form" class="space-y-3 xl:space-y-4 3xl:space-y-5 p-6 2xl:p-10 3xl:p-14 bg-white border border-stone-200 rounded-lg text-left shadow-xs hover-lift transition-transform duration-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 xl:gap-4 3xl:gap-5">
              <div>
                <label for="greenfield-name" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-stone-500 font-bold block mb-1 3xl:mb-2">Your Full Name</label>
                <input id="greenfield-name" name="name" type="text" required placeholder="Alistair Graham" class="w-full border border-stone-200 p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base focus:outline-none focus:border-[#2C5E3B]" />
              </div>
              <div>
                <label for="greenfield-postcode" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-stone-500 font-bold block mb-1 3xl:mb-2">North East Postcode</label>
                <input id="greenfield-postcode" name="postcode" type="text" required placeholder="e.g. NE65 1AA" class="w-full border border-stone-200 p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base focus:outline-none focus:border-[#2C5E3B]" />
              </div>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 xl:gap-4 3xl:gap-5">
              <div>
                <label for="greenfield-dimensions" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-stone-500 font-bold block mb-1 3xl:mb-2">Garden Dimensions</label>
                <input id="greenfield-dimensions" name="dimensions" type="text" placeholder="e.g. 12m x 8m" class="w-full border border-stone-200 p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base focus:outline-none focus:border-[#2C5E3B]" />
              </div>
              <div>
                <label for="greenfield-work-type" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-stone-500 font-bold block mb-1 3xl:mb-2">Core Work Needed</label>
                <select id="greenfield-work-type" name="work-type" class="w-full border border-stone-200 p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base text-stone-600 focus:outline-none bg-white">
            ...
            <div>
              <label for="greenfield-details" class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-stone-500 font-bold block mb-1 3xl:mb-2">Transform details</label>
              <textarea id="greenfield-details" name="details" rows="4" 3xl:rows="5" placeholder="Tell us about moss issues, water pooling in corners, or required sandstone paving outlines..." class="w-full border border-stone-200 p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base focus:outline-none focus:border-[#2C5E3B] resize-none font-sans"></textarea>
            </div>

            <div>
              <p class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-stone-500 font-bold block mb-1 3xl:mb-2">Upload Site Photo (garden_weeds.jpg)</p>
              ...
              <label for="greenfield-photo" class="cursor-default border border-dashed border-stone-300 rounded p-4 xl:p-6 3xl:p-8 text-center hover:border-[#2C5E3B]/40 hover:text-[#2C5E3B] hover:shadow-[0_0.85rem_2rem_rgba(15,23,42,0.06)] text-stone-600 flex flex-col items-center transition-all">
                ...
                <span class="text-[10px] xl:text-xs 3xl:text-sm font-mono">Select photographs of your current lawn</span>
              </label>
            </div>

            <button type="submit" class="cursor-default w-full bg-[#2C5E3B] hover:bg-[#1E4228] text-white font-bold py-3.5 xl:py-4.5 3xl:py-5 rounded text-xs xl:text-sm 3xl:text-base uppercase tracking-widest hover-button-polish font-mono border-none text-center">
      ...
      <!-- Footer -->
      <footer class="border-t border-stone-200 bg-white py-8 text-center text-xs text-stone-600 font-mono">
        © 2026 Septen
      </footer>
