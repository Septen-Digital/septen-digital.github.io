...
export function renderCarlsCoffee(container: DemoContainer): void {
  ...
  container.innerHTML = `
    <div data-carls-scroll-root class="bg-(--carls-brew-espresso) min-h-screen text-(--carls-text-cocoa) selection:bg-(--carls-accent-terracotta)/15 text-left">
      <!-- Top Banner Section -->
      <div data-carls-sticky-banner class="sticky top-0 z-60 bg-(--carls-brew-espresso) text-(--carls-banner-cream) px-6 py-3 flex flex-col sm:flex-row justify-between items-center text-xs border-b border-white/10 font-sans gap-2 text-center shadow-[0_1px_0_rgba(255,255,255,0.04),0_6px_22px_rgba(0,0,0,0.25)]">
      ...
      <section id="hero" class="relative bg-(--carls-dark-brown) overflow-hidden border-b border-white/10 min-h-[calc(100svh-6rem)] md:min-h-[calc(100svh-4.5rem)] flex flex-col justify-center rounded-none">
        ...
        <div class="relative z-10 w-full max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-5 sm:px-6 xl:px-10 2xl:px-14 3xl:px-20 py-10 md:py-12 xl:py-16 3xl:py-24 space-y-5 md:space-y-6 xl:space-y-8 3xl:space-y-10 text-left" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-[0.25em] text-(--carls-accent-terracotta) font-extrabold font-mono block">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 xl:gap-6 pt-3 xl:pt-6 max-w-xl 2xl:max-w-2xl">
            <a
              href="#menu"
              class="flex items-center justify-center bg-(--carls-dark-brown) hover:bg-(--carls-brew-espresso) text-white font-black text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4 3xl:py-5 px-6 xl:px-8 3xl:px-10 rounded-xl transition-colors uppercase tracking-wider text-center border-none shadow-[0_10px_40px_rgba(0,0,0,0.22)] cursor-default"
            >
          ...
          <div class="flex flex-wrap gap-4 xl:gap-6 pt-4 xl:pt-6 text-xs xl:text-sm 3xl:text-base font-mono text-(--carls-banner-cream)">
      ...
      <section class="max-w-6xl 2xl:max-w-7xl 3xl:max-w-360 4xl:max-w-[110rem] mx-auto px-4 py-12 md:py-16 2xl:py-20 3xl:py-24 relative">
        ...
        <div id="menu" class="bg-(--carls-chalk-bg) text-(--carls-chalk-text) rounded-xl p-6 md:p-10 2xl:p-14 3xl:p-16 shadow-[0_10px_40px_rgba(0,0,0,0.28)] border-4 border-(--carls-chalk-border) relative overflow-hidden hover-lift transition-transform duration-500" data-reveal>
          ...
          <div class="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 3xl:gap-12 divide-y md:divide-y-0 md:divide-x divide-(--carls-chalk-border)/60">
              ...
              <div class="space-y-5">
                ${espressoMenu
                  ...
                  <div class="group cursor-default">
                    <div class="flex justify-between font-serif font-semibold text-(--carls-chalk-text)">
                      <span class="group-hover:text-(--carls-accent-terracotta) transition-colors">${item.name}</span>
                      <span>${item.price}</span>
                    </div>
                    <p class="text-xs text-(--carls-text-cocoa-soft) mt-1">${item.desc}</p>
                  </div>
                `,
                  )
                  .join("")}
              ...
              <div class="space-y-5 3xl:space-y-7" id="carls-spec-selector">
                ${signatures
                  ...
                  >
                    ...
                    <p class="text-xs xl:text-sm 3xl:text-base text-(--carls-text-cocoa-soft) mt-1 3xl:mt-2">${spec.desc}</p>
                    <div class="roaster-note mt-2 3xl:mt-3 text-[10px] xl:text-xs 3xl:text-sm text-(--carls-accent-terracotta) bg-(--carls-accent-terracotta)/10 px-2 py-1 3xl:px-3 3xl:py-1.5 rounded hidden font-mono leading-relaxed"> 
            ...
            <div class="space-y-6 3xl:space-y-8 pt-6 md:pt-0 md:pl-6 3xl:md:pl-8">
              <h3 class="font-serif text-xl xl:text-2xl 3xl:text-3xl text-(--carls-accent-terracotta) border-b border-(--carls-accent-terracotta)/20 pb-2 3xl:pb-3">
              ...
              <div class="space-y-5 3xl:space-y-7">
                ${kitchenMenu
                  ...
                  <div class="group cursor-default">
                    ...
                    <p class="text-xs xl:text-sm 3xl:text-base text-(--carls-text-cocoa-soft) mt-1 3xl:mt-2">${item.desc}</p>
                  </div>
                `,
                  )
                  .join("")}
              ...
              <!-- Slate Note -->
              <div class="mt-4 3xl:mt-6 p-3 3xl:p-5 bg-(--carls-slate-note) border border-(--carls-chalk-border)/60 text-xs xl:text-sm 3xl:text-base text-white rounded-xl font-mono leading-relaxed">
          ...
          <div class="relative space-y-6 md:space-y-8 3xl:space-y-12" data-reveal>
            <div class="relative grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-8 3xl:gap-10 items-stretch">
              <div class="md:col-span-7 relative bg-(--carls-slate-note) border border-(--carls-chalk-border) rounded-xl p-6 md:p-8 2xl:p-10 3xl:p-14 space-y-5 3xl:space-y-7">
                <div class="flex items-center justify-between gap-3 pb-3 3xl:pb-5 border-b border-(--carls-chalk-border)/60">
                  <div class="flex items-center gap-3 3xl:gap-5">
                    ...
                    <div>
                      <p class="font-mono text-[10px] md:text-[11px] xl:text-xs 3xl:text-sm uppercase tracking-[0.22em] text-white/60">${beanStoryCards[0].eyebrow}</p>
                ...
                <div class="space-y-3 3xl:space-y-5 text-[14px] md:text-[14.5px] xl:text-base 2xl:text-lg 3xl:text-xl leading-[1.75] text-white">
                  <div class="flex gap-3 3xl:gap-5">
                    <span class="shrink-0 font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-(--carls-accent-terracotta) pt-1 3xl:pt-1.5">Origin trip</span>
                    <p>Carl travels to origin most winters, usually in the lull after Christmas before the spring green coffees arrive.</p>
                  </div>
                  <div class="flex gap-3 3xl:gap-5">
                    <span class="shrink-0 font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-(--carls-accent-terracotta) pt-1 3xl:pt-1.5">Farmer ties</span>
                    <p>Buys from the same farmers he has been working with for the last seven years · not spot market, not importer shortlists.</p>
                  </div>
                  <div class="flex gap-3 3xl:gap-5">
                    <span class="shrink-0 font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-(--carls-accent-terracotta) pt-1 3xl:pt-1.5">Cupping</span>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 3xl:gap-3 pt-2 3xl:pt-4">
                  <div class="border border-(--carls-chalk-border)/60 rounded-lg px-2.5 py-2 3xl:px-4 3xl:py-3 text-center">
                    ...
                    <p class="font-mono text-[9px] xl:text-[10px] 3xl:text-xs uppercase tracking-wider text-white/60 mt-0.5 3xl:mt-1">Kochere · ETH</p>
                  </div>
                  <div class="border border-(--carls-chalk-border)/60 rounded-lg px-2.5 py-2 3xl:px-4 3xl:py-3 text-center">
                    <p class="font-serif text-[12px] md:text-[12.5px] xl:text-sm 3xl:text-lg text-white leading-tight">Huila</p>
                    <p class="font-mono text-[9px] xl:text-[10px] 3xl:text-xs uppercase tracking-wider text-white/60 mt-0.5 3xl:mt-1">Colombia</p>
                  </div>
                  <div class="border border-(--carls-chalk-border)/60 rounded-lg px-2.5 py-2 3xl:px-4 3xl:py-3 text-center">
                    <p class="font-serif text-[12px] md:text-[12.5px] xl:text-sm 3xl:text-lg text-white leading-tight">Gitesi</p>
                    <p class="font-mono text-[9px] xl:text-[10px] 3xl:text-xs uppercase tracking-wider text-white/60 mt-0.5 3xl:mt-1">Rwanda</p>
                  </div>
                  <div class="border border-(--carls-chalk-border)/60 rounded-lg px-2.5 py-2 3xl:px-4 3xl:py-3 text-center">
                    <p class="font-serif text-[12px] md:text-[12.5px] xl:text-sm 3xl:text-lg text-white leading-tight">Mandheling</p>
                    <p class="font-mono text-[9px] xl:text-[10px] 3xl:text-xs uppercase tracking-wider text-white/60 mt-0.5 3xl:mt-1">Sumatra</p>
                  </div>
                </div>
              </div>
              <div class="md:col-span-5 relative bg-(--carls-slate-note) border border-(--carls-chalk-border) rounded-xl p-6 md:p-7 2xl:p-10 3xl:p-12 space-y-4 3xl:space-y-6 md:translate-y-6">
                <div class="flex items-center gap-3 3xl:gap-5">
                  ...
                  <div>
                    <p class="font-mono text-[10px] md:text-[11px] xl:text-xs 3xl:text-sm uppercase tracking-[0.22em] text-white/60">${beanStoryCards[1].eyebrow}</p>
                ...
                <div class="pt-2 3xl:pt-4 border-t border-dashed border-(--carls-chalk-border)/60 flex items-center justify-between">
                  <span class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-white/60">Development</span>
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-8 3xl:gap-10 items-stretch">
                ...
                <div class="absolute -top-3.5 left-6 md:left-10 3xl:-top-5">
                  <span class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-(--carls-dark-brown) bg-(--carls-accent-terracotta) px-3 py-1 3xl:px-5 3xl:py-1.5 rounded-full font-bold">on the bar every day</span>
                </div>
                <div class="flex items-start md:items-center justify-between gap-4 3xl:gap-6 pt-2 3xl:pt-4">
                  <div class="flex items-start md:items-center gap-3 md:gap-4 3xl:gap-6">
                    ...
                    <div>
                      <p class="font-mono text-[10px] md:text-[11px] xl:text-xs 3xl:text-sm uppercase tracking-[0.22em] text-white/60">${beanStoryCards[2].eyebrow}</p>
                  ...
                  <div class="hidden sm:flex items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-white/60">Roast curve</span>
                ...
                <div class="border-l-2 3xl:border-l-[3px] border-(--carls-accent-terracotta)/55 pl-4 pr-1 3xl:pl-8 space-y-3 3xl:space-y-5">
                  ...
                  <div class="flex flex-wrap items-center gap-x-4 3xl:gap-x-6 gap-y-1.5 3xl:gap-y-2.5 pt-1 3xl:pt-2 border-t border-(--carls-chalk-border)/60">
                    <span class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-white/60">Default espresso</span>
                    <span class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-white/60">·</span>
                  </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 3xl:gap-7">
                  <div class="space-y-2.5 3xl:space-y-4 border border-(--carls-chalk-border)/60 rounded-lg p-3.5 3xl:p-6 bg-(--carls-base-brew)/70">
                    <p class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-(--carls-accent-terracotta) pb-1 3xl:pb-2 border-b border-(--carls-chalk-border)/60">Blend recipe</p>
                  ...
                  <div class="space-y-2.5 3xl:space-y-4 border border-(--carls-chalk-border)/60 rounded-lg p-3.5 3xl:p-6 bg-(--carls-base-brew)/70">
                    <p class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-(--carls-banner-cream) pb-1 3xl:pb-2 border-b border-(--carls-chalk-border)/60">Pull recipe</p>
                    <div class="space-y-2 3xl:space-y-3 text-[13.5px] md:text-[14px] xl:text-base 2xl:text-lg 3xl:text-xl text-white">
                      <div class="flex items-center justify-between gap-4 3xl:gap-6">
                ...
                <div class="flex flex-wrap items-end gap-2 3xl:gap-3 pt-2 3xl:pt-4 border-t border-(--carls-chalk-border)/60">
                  <div class="space-y-2 3xl:space-y-3 flex-1 min-w-0">
                    <p class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-white/60">Tasting</p>
              ...
              <div class="md:col-span-4 relative bg-(--carls-slate-note) border border-(--carls-banner-cream)/40 rounded-xl p-6 md:p-7 2xl:p-10 3xl:p-12 space-y-4 3xl:space-y-6 md:translate-y-8">
                <div class="flex items-center justify-between gap-3 3xl:gap-5 pb-3 3xl:pb-5 border-b border-dashed border-(--carls-chalk-border)/60">
                  <div class="flex items-center gap-3 3xl:gap-5">
                    ...
                    <div>
                      <p class="font-mono text-[10px] md:text-[11px] xl:text-xs 3xl:text-sm uppercase tracking-[0.22em] text-white/60">${beanStoryCards[3].eyebrow}</p>
                  ...
                  <span class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-(--carls-banner-cream)">Peru</span>
                </div>
                ...
                <ul class="space-y-2 3xl:space-y-3.5 border-t border-(--carls-chalk-border)/60 pt-3 3xl:pt-5 text-[12.5px] md:text-[13px] xl:text-sm 3xl:text-base text-white">
                  <li class="flex gap-2 3xl:gap-3 items-start">
                    <span class="shrink-0 text-(--carls-banner-cream) font-bold text-[10px] xl:text-xs 3xl:text-sm pt-1 3xl:pt-1.5">❐</span>
        ...
        <div class="max-w-6xl 2xl:max-w-7xl 3xl:max-w-[100rem] 4xl:max-w-[120rem] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 3xl:gap-14 items-start">
          ...
          <header class="lg:col-span-8 space-y-6 md:space-y-7 3xl:space-y-10">
            <div class="flex items-center gap-2 3xl:gap-3">
              ...
              <span class="font-mono text-[11px] xl:text-xs 3xl:text-sm text-(--carls-accent-terracotta) font-bold tracking-widest uppercase inline-block">The Atmosphere</span>
            </div>
          ...
          <div class="lg:col-span-4 bg-(--carls-base-brew) p-4 sm:p-5 3xl:p-7 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.28)] border border-white/10 hover-lift transition-transform duration-500 rotate-1 hover:rotate-0" data-reveal data-reveal-delay="120">
            <div class="relative aspect-4/3 rounded-sm overflow-hidden bg-(--carls-dark-brown)/10">
              ...
              <div class="absolute top-3 left-3 3xl:top-5 3xl:left-5 inline-flex items-center gap-1.5 border border-(--carls-chalk-border) px-2 py-0.5 3xl:px-3 3xl:py-1 text-[9px] xl:text-[10px] 3xl:text-xs font-mono font-bold uppercase tracking-widest text-(--carls-chalk-text) bg-(--carls-slate-note)">
                Bailey Street
              </div>
              <div class="absolute bottom-3 right-3 3xl:bottom-5 3xl:right-5 inline-flex items-center gap-1.5 border border-(--carls-chalk-border) px-2 py-0.5 3xl:px-3 3xl:py-1 text-[9px] xl:text-[10px] 3xl:text-xs font-mono uppercase tracking-widest text-(--carls-chalk-text) bg-(--carls-slate-note)">
            ...
            <div class="pt-4 sm:pt-5 3xl:pt-7 pb-3 sm:pb-4 3xl:pb-5 text-center space-y-1.5 3xl:space-y-2.5">
              ...
              <p class="font-mono text-[10px] xl:text-xs 3xl:text-sm text-white tracking-widest uppercase">
            ...
            <div class="md:col-span-5 grid grid-rows-[auto_auto] gap-4 md:gap-5 3xl:gap-6">
              <div class="bg-(--carls-slate-note) border border-(--carls-chalk-border) rounded-xl p-3.5 md:p-4 2xl:p-5 3xl:p-6 space-y-2 3xl:space-y-3">
                ...
                <ul class="space-y-1.5 text-white text-[13.5px] md:text-[14px] xl:text-sm 3xl:text-base leading-[1.55]">
                  <li><span class="text-(--carls-accent-terracotta) mr-2 text-[10px] xl:text-xs 3xl:text-sm">✦</span>Mon to Fri · 8am to 4pm</li>
                  <li><span class="text-(--carls-accent-terracotta) mr-2 text-[10px] xl:text-xs 3xl:text-sm">✦</span>Saturday · 9am to 4pm</li>
                  <li><span class="text-(--carls-accent-terracotta) mr-2 text-[10px] xl:text-xs 3xl:text-sm">✦</span>Sunday · 9.30am to 3.30pm</li>
                  <li><span class="text-(--carls-accent-terracotta) mr-2 text-[10px] xl:text-xs 3xl:text-sm">✦</span>40 yards to Framwellgate riverside</li>
                </ul>
              </div>
              <div class="bg-(--carls-slate-note) border border-(--carls-chalk-border) rounded-xl p-3.5 md:p-4 2xl:p-5 3xl:p-6 space-y-2 3xl:space-y-3">
                ...
                <ul class="space-y-1.5 text-white text-[13px] md:text-[13.5px] xl:text-sm 3xl:text-base leading-[1.55]">
                  <li><span class="text-(--carls-accent-terracotta) mr-2 text-[10px] xl:text-xs 3xl:text-sm">·</span>22 covers · 8 window stools · 4 perches</li>
                  <li><span class="text-(--carls-accent-terracotta) mr-2 text-[10px] xl:text-xs 3xl:text-sm">·</span>Low jazz weekdays · bluegrass Saturdays</li>
                  <li><span class="text-(--carls-accent-terracotta) mr-2 text-[10px] xl:text-xs 3xl:text-sm">·</span>Wi-Fi password printed on your receipt</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            ${customerTestimonials
              ...
              <div class="space-y-1.5 3xl:space-y-2.5" data-reveal>
                ...
                <div class="pt-1.5 3xl:pt-2.5 border-t border-white/10">
                  ...
                  <span class="block text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-white mt-0.5 3xl:mt-1">${t.context}</span>
                </div>
              </div>
            `,
              )
      ...
      <section class="bg-(--carls-base-brew) text-white py-4 3xl:py-6 border-y border-white/10">
        <div class="max-w-6xl 3xl:max-w-[100rem] 4xl:max-w-[120rem] mx-auto px-4 xl:px-10 3xl:px-20 flex flex-col sm:flex-row justify-between items-center gap-4 3xl:gap-6 text-xs xl:text-sm 3xl:text-base font-mono">
          <div class="flex items-center gap-2 3xl:gap-3">
      ...
      <section class="bg-(--carls-brew-espresso) py-16 2xl:py-20 3xl:py-28 px-4 xl:px-10 3xl:px-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 3xl:gap-10 items-stretch">
            ...
            <div class="flex justify-between items-center mb-4 3xl:mb-6">
              <h3 class="font-serif text-sm xl:text-base 3xl:text-lg font-bold flex items-center gap-1.5 text-white">
                <span class="inline-flex items-center gap-2 3xl:gap-3">
                  ...
                  <span class="text-[10px] xl:text-xs 3xl:text-sm font-mono font-bold uppercase tracking-[0.15em] text-white">From The Shop Door</span>
                </span>
              </h3>
            </div>
            <div class="space-y-1 3xl:space-y-2">
              ${durhamLandmarks
                ...
                <div class="flex justify-between items-center border-b border-(--carls-chalk-border)/60 py-3 3xl:py-5 last:border-0 group">
                  ...
                  <span class="font-mono text-[11px] md:text-xs xl:text-sm 3xl:text-base text-white font-bold group-hover:text-white transition-colors">${landmark.time}</span>
                </div>
              `,
                )
                .join("")}
            ...
            <div class="flex justify-between items-center mb-3 3xl:mb-5 gap-3">
              <h3 class="font-serif text-sm xl:text-base 3xl:text-lg font-bold flex items-center gap-1.5 text-white min-w-0">
                <span class="inline-flex items-center gap-2 3xl:gap-3 whitespace-nowrap">
                  <span class="w-6 h-px 3xl:w-10 3xl:h-0.5 bg-(--carls-chalk-border)"></span>
                  <span class="text-[10px] xl:text-xs 3xl:text-sm font-mono font-bold uppercase tracking-[0.15em] text-white whitespace-nowrap">Bailey Street Area</span>
                </span>
              </h3>
              <span class="text-[9px] sm:text-[10px] xl:text-xs 3xl:text-sm font-mono text-white tracking-widest uppercase whitespace-nowrap">DH1 · Peninsula</span>
            </div>
            ...
            <div class="relative w-full h-55 sm:h-67.5 md:h-85 2xl:h-105 3xl:h-125 rounded-xl overflow-hidden border border-(--carls-chalk-border)/60 bg-(--carls-brew-espresso)">
              ...
              <div class="absolute left-[14%] top-[46%] -translate-x-1/2 -translate-y-full z-20 pointer-events-none" aria-hidden="true">
                <div class="relative flex flex-col items-center">
                  ...
                  <div class="w-6 h-6 sm:w-7 sm:h-7 3xl:w-10 3xl:h-10 rounded-full bg-(--carls-accent-terracotta) border-2 3xl:border-[3px] border-white shadow-[0_4px_14px_rgba(226,149,120,0.55)] flex items-center justify-center shrink-0 relative z-10">
                    <span class="text-[9px] sm:text-[10px] 3xl:text-sm font-black text-white leading-none">C</span>
                  </div>
              ...
              <div class="absolute bottom-1.5 left-1.5 sm:bottom-2 sm:left-2 md:bottom-2 md:left-2.5 3xl:bottom-4 3xl:left-4 flex flex-wrap items-center gap-x-3 sm:gap-x-4 3xl:gap-x-6 gap-y-1 px-2 py-1 sm:px-2 sm:py-1.5 3xl:px-3 3xl:py-2 max-w-[90%]">
                <div class="flex items-center gap-1.5 3xl:gap-2.5">
                  ...
                  <span class="font-mono text-[8px] sm:text-[9px] xl:text-[10px] 3xl:text-xs text-white uppercase tracking-wider whitespace-nowrap">You are here</span>
                </div>
                <div class="flex items-center gap-1.5 3xl:gap-2.5">
                  <div class="w-6 sm:w-8 3xl:w-12 h-1 3xl:h-1.25 rounded-full bg-(--carls-accent-terracotta)"></div>
                  <span class="font-mono text-[8px] sm:text-[9px] xl:text-[10px] 3xl:text-xs text-white uppercase tracking-wider whitespace-nowrap">Walk route</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="lg:col-span-4 lg:row-span-2 flex flex-col bg-(--carls-slate-note) border border-(--carls-chalk-border) p-6 3xl:p-10 rounded-xl hover-lift transition-transform duration-500 shadow-[0_10px_40px_rgba(0,0,0,0.22)]" data-reveal data-reveal-delay="140">
            <div class="flex justify-between items-center mb-4 3xl:mb-6 shrink-0">
              <h3 class="font-serif text-sm xl:text-base 3xl:text-lg font-bold flex items-center gap-1.5 text-white">
                <span class="inline-flex items-center gap-2 3xl:gap-3">
                  <span class="w-6 h-px 3xl:w-10 3xl:h-0.5 bg-(--carls-chalk-border)"></span>
                  <span class="text-[10px] xl:text-xs 3xl:text-sm font-mono font-bold uppercase tracking-[0.15em] text-white">Typical Weekly Flow</span>
                </span>
              </h3>
            </div>

            <div class="flex flex-col space-y-1.5 3xl:space-y-2.5">
              <div class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-wider text-white pb-1 3xl:pb-2">Tuesday – Thursday</div>
              <div class="flex flex-col gap-2.5 3xl:gap-4">
              ${weekdayFootfall
                .map(
                  (data) => `
                <div class="space-y-1.5 3xl:space-y-2.5">
                  <div class="flex justify-between text-xs xl:text-sm 3xl:text-base font-mono">
            ...
            <div class="flex flex-col space-y-1.5 3xl:space-y-2.5">
              <div class="text-[10px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-wider text-white pb-1 3xl:pb-2">Saturday</div>
              <div class="flex flex-col gap-2.5 3xl:gap-4">
              ${saturdayFootfall
                .map(
                  (data) => `
          ...
          <div class="lg:col-span-8 bg-(--carls-slate-note) border border-(--carls-chalk-border) p-4 sm:p-5 3xl:p-8 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.22)] hover-lift transition-transform duration-500" data-reveal data-reveal-delay="180">
            <div class="font-mono text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest text-white mb-3 3xl:mb-5">Getting Here</div>
        ...
        <div class="relative z-10 max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 3xl:gap-12 items-stretch">
          <div class="md:col-span-5 space-y-5 3xl:space-y-7" data-reveal>
            <div class="bg-(--carls-slate-note) rounded-xl border border-(--carls-chalk-border) p-6 md:p-7 3xl:p-10 shadow-[0_10px_40px_rgba(0,0,0,0.22)] space-y-5 3xl:space-y-7 h-full">
              <div class="flex items-center gap-2 3xl:gap-3">
                <span class="w-8 h-px 3xl:w-12 3xl:h-0.5 bg-(--carls-accent-terracotta)/60"></span>
                <span class="font-mono text-[11px] xl:text-xs 3xl:text-sm text-(--carls-accent-terracotta) font-bold tracking-widest uppercase inline-block">Cupping & Private Hire</span>
              </div>
          ...
          <form id="carls-booking-form" class="md:col-span-7 bg-(--carls-slate-note) p-6 md:p-8 3xl:p-12 rounded-xl border border-(--carls-chalk-border) space-y-4 3xl:space-y-6 shadow-[0_10px_40px_rgba(0,0,0,0.22)] hover-lift transition-transform duration-500 relative" data-reveal data-reveal-delay="120">
            <div class="pb-2 3xl:pb-4 mb-1 3xl:mb-2">
              ...
              <p class="text-[11px] xl:text-xs 3xl:text-sm font-mono mt-1 3xl:mt-2 text-white uppercase tracking-widest">We aim to reply the same working day</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 3xl:gap-6">
              <div>
                <label for="carls-name" class="block text-[11px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-wider text-white pb-1.5 3xl:pb-2.5">Full Name</label>
                <input id="carls-name" name="name" type="text" placeholder="e.g. Olivia Carter" class="w-full rounded-xl border border-(--carls-chalk-border)/60 bg-(--carls-base-brew) px-3 py-2.5 xl:p-3.5 3xl:p-4 text-sm xl:text-base 3xl:text-lg text-white placeholder-white/55 focus:outline-none focus:border-(--carls-accent-terracotta) focus:ring-2 focus:ring-(--carls-accent-terracotta)/20" />
              </div>
              <div>
                <label for="carls-email" class="block text-[11px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-wider text-white pb-1.5 3xl:pb-2.5">Email Address</label>
              ...
              <div>
                <label for="carls-date" class="block text-[11px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-wider text-white pb-1.5 3xl:pb-2.5">Booking Date</label>
              ...
              <div>
                <label for="carls-guests" class="block text-[11px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-wider text-white pb-1.5 3xl:pb-2.5">Number of Guests</label>
                <select id="carls-guests" name="guests" class="w-full rounded-xl border border-(--carls-chalk-border)/60 bg-(--carls-base-brew) px-3 py-2.5 xl:p-3.5 3xl:p-4 text-sm xl:text-base 3xl:text-lg text-white placeholder-white/55 focus:outline-none focus:border-(--carls-accent-terracotta) focus:ring-2 focus:ring-(--carls-accent-terracotta)/20 appearance-none cursor-default">
            ...
            <div>
              <label for="carls-message" class="block text-[11px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-wider text-white pb-1.5 3xl:pb-2.5">Any Notes (optional)</label>
            ...
            <button
              type="submit"
              class="w-full md:w-auto bg-(--carls-accent-terracotta) hover:bg-(--carls-accent-terracotta)/90 text-(--carls-dark-brown) font-black text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4.5 3xl:py-5 px-8 xl:px-10 3xl:px-12 rounded-xl transition-all hover-button-polish cursor-default border-none shadow-[0_10px_40px_rgba(0,0,0,0.22)] uppercase tracking-wider"
            >
              Send Enquiry
            </button>
          </form>
