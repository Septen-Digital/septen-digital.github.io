    ...
    <div class="bg-[#0B0F19] min-h-screen text-[#E2E8F0] font-sans antialiased text-left selection:bg-amber-500/20 flex flex-col">
      ...
      <nav class="bg-[#0F1422] border-b border-slate-800">
        <div class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl mx-auto px-6 xl:px-10 3xl:px-20 py-4 xl:py-5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div class="flex flex-wrap justify-center items-center gap-x-4 gap-y-2.5 md:gap-x-6 3xl:gap-x-8 text-xs xl:text-sm 3xl:text-base font-semibold uppercase tracking-wider text-slate-400">
            ...
            <button 
              id="fitness-nav-cta"
              class="bg-amber-500 hover:bg-amber-600 text-slate-950 font-extrabold px-4 py-2 xl:px-5 xl:py-2.5 rounded text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-widest transition-colors hover-button-polish font-mono border-none cursor-pointer shrink-0"
            >
              Join Gym
            </button>
          </div>
      ...
      <section class="relative bg-[#0F1422] overflow-hidden border-b border-slate-800 min-h-[calc(100svh-6rem)] md:min-h-[calc(100svh-4.5rem)] flex flex-col justify-center">
        ...
        <div class="relative z-10 w-full max-w-4xl 2xl:max-w-5xl 3xl:max-w-6xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20 py-10 md:py-12 xl:py-16 3xl:py-24 space-y-6 xl:space-y-8 3xl:space-y-10 text-left" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase tracking-[0.25em] text-amber-300 font-extrabold font-mono block">
          ...
          <div class="flex flex-wrap gap-4 xl:gap-6 pt-3 xl:pt-6">
            <a
              href="#contact"
              class="bg-amber-500 hover:bg-amber-600 text-slate-950 font-black text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4 3xl:py-5 px-6 xl:px-8 3xl:px-10 rounded transition-all hover-button-polish cursor-pointer border-none shadow-md uppercase tracking-wider inline-flex items-center justify-center"
            >
              Get Free Day Pass
            </a>
            <a 
              href="#timetables"
              class="bg-slate-950 hover:border-amber-500/60 hover:text-amber-300 hover:shadow-[0_0.85rem_2rem_rgba(245,158,11,0.12)] text-white border border-solid border-slate-705 font-bold text-xs xl:text-sm 3xl:text-base py-3.5 xl:py-4 3xl:py-5 px-6 xl:px-8 3xl:px-10 rounded transition-all text-center cursor-pointer flex items-center justify-center"
            >
              View Class Times
            </a>
          </div>

          <div class="flex flex-wrap gap-6 xl:gap-8 pt-4 xl:pt-6 text-xs xl:text-sm 3xl:text-base font-mono text-slate-200">
      ...
      <section id="services" class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20 py-20 2xl:py-24 3xl:py-28 text-left">
        <div class="border-b border-slate-800 pb-5 3xl:pb-8 mb-12 3xl:mb-16" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-amber-500 font-black block">Core Training</span>
          ...
          <p class="text-xs xl:text-sm 3xl:text-base text-slate-400 italic mt-1 3xl:mt-3 font-serif font-light">Plainly explained, results-driven coaching loops.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 3xl:gap-12">
          ...
          <div class="bg-[#121829] border border-slate-800 p-6 3xl:p-10 rounded-lg space-y-3 3xl:space-y-5 hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="60">
            ...
            <p class="text-xs md:text-sm xl:text-base 3xl:text-lg text-slate-300 leading-relaxed font-sans">
          ...
          <div class="bg-[#121829] border border-slate-800 p-6 3xl:p-10 rounded-lg space-y-3 3xl:space-y-5 hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="110">
            ...
            <p class="text-xs md:text-sm xl:text-base 3xl:text-lg text-[#E2E8F0] leading-relaxed font-sans">
      ...
      <section id="coaches" class="bg-[#0E1322] border-y border-slate-800 py-20 2xl:py-24 3xl:py-28">
        <div class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20 text-left">
          ...
          <div class="mb-12 3xl:mb-16 border-b border-slate-800 pb-5 3xl:pb-8" data-reveal>
            <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-amber-500 font-bold block">Our Instructors</span>
            ...
            <p class="text-xs xl:text-sm 3xl:text-base text-slate-400 font-serif italic mt-1 3xl:mt-3 pb-1 font-light">Accredited personal trainers focused on genuine technique support.</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 3xl:gap-12">
            ...
            <div class="bg-[#13192B] border border-slate-800 p-6 3xl:p-10 rounded-lg space-y-4 3xl:space-y-6 hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="60">
              ...
              <div class="space-y-1 3xl:space-y-2">
                ...
                <span class="text-[9px] xl:text-xs 3xl:text-sm font-mono font-bold bg-amber-500/10 text-amber-400 border border-amber-900/40 px-2 py-0.5 3xl:px-3 3xl:py-1 rounded uppercase">
                  Head Performance Coach
                </span>
              </div>
              <p class="text-xs xl:text-sm 3xl:text-base text-slate-300 leading-relaxed font-sans">
              ...
              <div class="text-[10px] xl:text-xs 3xl:text-sm text-slate-300 font-mono italic mt-2 3xl:mt-4">
            ...
            <div class="bg-[#13192B] border border-slate-800 p-6 3xl:p-10 rounded-lg space-y-4 3xl:space-y-6 hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="110">
              ...
              <div class="text-[10px] xl:text-xs 3xl:text-sm text-slate-500 font-mono italic mt-2 3xl:mt-4">
      ...
      <section id="memberships" class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20 py-20 2xl:py-24 3xl:py-28 text-left">
        <div class="border-b border-slate-800 pb-5 3xl:pb-8 mb-12 3xl:mb-16" data-reveal>
          <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-amber-500 font-black block">Join Us</span>
          ...
          <p class="text-xs xl:text-sm 3xl:text-base text-slate-400 italic mt-1 3xl:mt-3 font-serif font-light">Honest flat-rate fees. No annoying tie-in contracts or startup card penalties.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 3xl:gap-12 max-w-4xl 3xl:max-w-5xl">
          ...
          <div class="bg-[#121829] border border-slate-800 p-8 2xl:p-10 3xl:p-14 rounded-xl relative overflow-hidden space-y-6 3xl:space-y-8 flex flex-col justify-between hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="60">
            <div class="space-y-4 3xl:space-y-6">
              <div>
                <span class="text-[9px] xl:text-xs 3xl:text-sm font-mono bg-slate-800 text-slate-300 font-extrabold px-2 py-0.5 3xl:px-3 3xl:py-1 rounded uppercase tracking-widest">
                  Floor Only Access
                </span>
                <p class="text-2xl xl:text-3xl 2xl:text-4xl 3xl:text-5xl font-black text-white mt-2 3xl:mt-3">£35.00 / <span class="text-xs xl:text-sm 3xl:text-base text-slate-400 font-normal">month</span></p>
                <p class="text-xs xl:text-sm 3xl:text-base text-slate-400 mt-1 3xl:mt-2">Excellent for experienced, self-directed lifters.</p>
              </div>

              <ul class="space-y-2.5 3xl:space-y-3.5 text-xs xl:text-sm 3xl:text-base text-slate-300">
            ...
            <button 
              ...
              class="w-full bg-transparent hover:bg-slate-800/80 text-white border border-slate-700 font-bold p-3 xl:p-4 3xl:p-5 text-xs xl:text-sm 3xl:text-base rounded transition-all hover-button-polish cursor-pointer uppercase tracking-wider"
            >
          ...
          <div class="bg-[#121829] border-2 border-amber-500 p-8 2xl:p-10 3xl:p-14 rounded-xl relative overflow-hidden space-y-6 3xl:space-y-8 shadow-lg shadow-amber-500/5 flex flex-col justify-between hover-lift transition-transform duration-300" data-reveal data-reveal-delay="120">
            <div class="absolute top-0 right-0 bg-amber-500 text-slate-950 px-3 py-1 3xl:px-4 3xl:py-1.5 font-mono font-black text-[9px] xl:text-xs 3xl:text-sm uppercase tracking-wider rounded-bl">
              Most Popular
            </div>

            <div class="space-y-4 3xl:space-y-6">
              <div>
                <span class="text-[9px] xl:text-xs 3xl:text-sm font-mono bg-amber-500/10 text-amber-400 font-extrabold px-2.5 py-0.5 3xl:px-3.5 3xl:py-1 rounded uppercase tracking-widest">
                  Coached Strength Pass
                </span>
                <p class="text-2xl xl:text-3xl 2xl:text-4xl 3xl:text-5xl font-black text-amber-500 mt-2 3xl:mt-3">£55.00 / <span class="text-xs xl:text-sm 3xl:text-base text-slate-400 font-normal">month</span></p>
                <p class="text-xs xl:text-sm 3xl:text-base text-slate-300 mt-1 3xl:mt-2">Our fully guided class & team technique access pass.</p>
              </div>

              <ul class="space-y-2.5 3xl:space-y-3.5 text-xs xl:text-sm 3xl:text-base text-slate-200">
            ...
            <button 
              ...
              class="w-full bg-amber-500 hover:bg-amber-600 text-slate-950 font-black p-3 xl:p-4 3xl:p-5 text-xs xl:text-sm 3xl:text-base rounded transition-all hover-button-polish cursor-pointer border-none uppercase tracking-wider"
            >
      ...
      <section id="timetables" class="bg-[#0E1322] border-t border-slate-800 py-20 2xl:py-24 3xl:py-28 text-left">
        <div class="max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-360 mx-auto px-6 xl:px-10 3xl:px-20">   
          ...
          <div class="mb-12 3xl:mb-16 border-b border-slate-800 pb-5 3xl:pb-8" data-reveal>
            <span class="text-[10px] xl:text-xs 3xl:text-sm uppercase font-mono tracking-widest text-amber-500 font-black block">Weekly Times</span>
            ...
            <p class="text-xs xl:text-sm 3xl:text-base text-slate-400 font-serif italic mt-1 3xl:mt-3 font-light">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 3xl:gap-12">
            ...
            <div class="bg-[#121829] border border-slate-800 rounded-lg p-5 2xl:p-7 3xl:p-10 space-y-4 3xl:space-y-6 hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="60">
              ...
              <div class="space-y-4 3xl:space-y-5 text-xs xl:text-sm 3xl:text-base">
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">06:00 AM - Power HIIT</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-amber-500/10 text-amber-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">ADVANCED</span>
                  </div>
                ...
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">12:00 PM - Iron Strength 101</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-cyan-950 text-cyan-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">CORE</span>
                  </div>
                ...
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">05:30 PM - Cardio Cycle</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-cyan-950 text-cyan-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">CORE</span>
                  </div>
            ...
            <div class="bg-[#121829] border border-slate-800 rounded-lg p-5 2xl:p-7 3xl:p-10 space-y-4 3xl:space-y-6 hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="110">
              ...
              <div class="space-y-4 3xl:space-y-5 text-xs xl:text-sm 3xl:text-base">
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">06:30 AM - Barbell Complex</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-amber-500/10 text-amber-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">ADVANCED</span>
                  </div>
                ...
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">12:30 PM - Core Stability</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-cyan-950 text-cyan-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">CORE</span>
                  </div>
                ...
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">06:00 PM - Athletic Conditioning</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-amber-500/10 text-amber-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">ADVANCED</span>
                  </div>
            ...
            <div class="bg-[#121829] border border-slate-800 rounded-lg p-5 2xl:p-7 3xl:p-10 space-y-4 3xl:space-y-6 hover-lift transition-transform duration-300 hover:border-amber-500/40" data-reveal data-reveal-delay="160">
              ...
              <div class="space-y-4 3xl:space-y-5 text-xs xl:text-sm 3xl:text-base">
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">07:00 AM - Row Intervals</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-cyan-950 text-cyan-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">CORE</span>
                  </div>
                ...
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">01:00 PM - Kettlebell Flow</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-cyan-950 text-cyan-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">CORE</span>
                  </div>
                ...
                <div class="space-y-1 3xl:space-y-2 text-left">
                  <div class="flex justify-between items-center gap-2 3xl:gap-3">
                    <span class="font-mono text-white font-extrabold text-[11px] xl:text-sm 3xl:text-base">05:30 PM - Joint Recovery</span>
                    <span class="text-[8px] xl:text-[10px] 3xl:text-xs bg-emerald-950 text-emerald-400 px-1.5 py-0.5 3xl:px-2.5 3xl:py-1 rounded shrink-0">RECOVERY</span>
                  </div>
      ...
      <section id="contact" class="bg-[#0B0F19] py-16 2xl:py-20 3xl:py-24 text-center border-t border-slate-800">
        <div class="max-w-xl 2xl:max-w-2xl 3xl:max-w-3xl mx-auto px-6 xl:px-10 3xl:px-20 space-y-6 3xl:space-y-8" data-reveal>
          ...
          <p class="text-xs xl:text-sm 3xl:text-base text-slate-400 max-w-sm 2xl:max-w-md 3xl:max-w-lg mx-auto leading-relaxed font-sans">
          ...
          <form id="fitness-contact-form" class="space-y-3.5 3xl:space-y-5 p-6 2xl:p-8 3xl:p-10 bg-[#0F1422] border border-slate-800 rounded-lg text-left shadow-md max-w-sm 2xl:max-w-md 3xl:max-w-lg mx-auto hover-lift transition-transform duration-300 hover:border-amber-500/40">
            <div>
              <label for="fitness-name" class="text-[9px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-slate-400 font-bold block mb-1 3xl:mb-2">Your Full Name</label>
              <input id="fitness-name" name="name" type="text" required placeholder="Marcus Vance" class="w-full bg-[#121829] border border-slate-800 text-white rounded p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base focus:outline-none focus:border-amber-500" />
            </div>
            <div>
              <label for="fitness-email" class="text-[9px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-slate-400 font-bold block mb-1 3xl:mb-2">Email Address</label>
              <input id="fitness-email" name="email" type="email" required placeholder="marcus@vance.com" class="w-full bg-[#121829] border border-slate-800 text-white rounded p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base focus:outline-none focus:border-amber-500" />
            </div>
            <div>
              <label for="fitness-goal" class="text-[9px] xl:text-xs 3xl:text-sm font-mono uppercase tracking-widest text-slate-400 font-bold block mb-1 3xl:mb-2">Core Training Goal</label>
              <select id="fitness-goal" name="goal" class="w-full bg-[#121829] border border-slate-800 text-slate-300 rounded p-2.5 xl:p-3.5 3xl:p-4 text-xs xl:text-sm 3xl:text-base focus:outline-none focus:border-amber-500">
            ...
            <button type="submit" class="w-full bg-amber-500 hover:bg-amber-600 text-slate-950 font-black p-3 xl:p-4 3xl:p-5 rounded text-xs xl:text-sm 3xl:text-base uppercase tracking-widest hover-button-polish border-none cursor-pointer font-sans">
              Submit My Request
            </button>
          </form>
        </div>
      ...
      <!-- Footer -->
      <footer class="border-t border-slate-900 bg-[#070A11] py-8 text-center text-xs text-slate-300 font-mono mt-auto">
        © 2026 Septen
      </footer>
