const iconPaths = {
  ...
  Sparkles: `<path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m11.314 11.314l.707.707M12 5a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7z"></path><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275Z"></path>`,
  ShieldCheck: `<path d="M20 13c0 5-3.5 7.5-7.66 9.7a1 1 0 0 1-.68 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path>`,
  ...
  ShieldAlert: `<path d="M20 13c0 5-3.5 7.5-7.66 9.7a1 1 0 0 1-.68 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1z"></path><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line>`,
  ...
  Hammer: `<path d="m15 5 4 4"></path><path d="M21.5 12a1 1 0 0 1-.13.3l-4.63 8.35a1 1 0 0 1-1.37.37l-3.23-1.8a1 1 0 0 1-.37-1.37l4.63-8.35a1 1 0 0 1 1.37-.37l3.23 1.8a1 1 0 0 1 .5.88z"></path><path D="M10 15H3a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1h7a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1z"></path>`,
  Shrub: `<path d="M12 22V17h0"></path><path d="M9 13.5c-1.5-1.5-2.5-.5-3 1-.5 1.5.5 2.5 1.5 3"></path><path d="M15 13.5c1.5-1.5 2.5-.5 3 1 .5 1.5-.5 2.5-1.5 3"></path><path d="M12 17c2-3 1.5-5.5.5-7-1.5-2-4.5-2-5.5-.5-1 1.5-.5 4.5.5 6"></path><path d="M12 17c-2-3-1.5-5.5-.5-7 1.5-2 4.5-2 5.5-.5 1 1.5.5 4.5-.5 6"></path>`,
  CheckCircle: `<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline>`,
  Upload: `<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line>`,
  Dumbbell: `<path d="M6.5 6.5h11M6.5 17.5h11M20.24 16.24l-3.53 3.53M3.76 7.76l3.53-3.53M16.24 3.76l3.53 3.53M7.76 20.24l-3.53-3.53"></path><rect x="15" y="1" width="3" height="6" rx="1"></rect><rect x="6" y="17" width="3" height="6" rx="1"></rect>`,
...
export function getIcon(name: IconName, className = "w-4 h-4"): string {
